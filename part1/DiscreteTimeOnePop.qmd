...
```{python}
#| label: fig-cobwebMal
#| fig-cap: "Animation of a cobweb diagram for the Malthusian model with $N_0 = 0.2$ and $r = 1.5$."
#| fig-show: false
...
gamma_greater1 = np.linspace(1, 4, 400) # N^*=0 unstable, non-zero N^* stable

# Compute fixed points
N_star_stable0 = np.zeros_like(gamma_less1)
N_star_unstable0 = np.zeros_like(gamma_greater1)
N_star_nonzero = np.sqrt(gamma_greater1 - 1)
...
ax.plot(gamma_greater1, N_star_unstable0, 'r')

# Plot N^* = sqrt(gamma-1) as stable
ax.plot(gamma_greater1, N_star_nonzero, 'g')

# Custom legend
stable_handle = Line2D([0], [0], color='green', lw=2, label='Stable')
unstable_handle = Line2D([0], [0], color='red', lw=2, label='Unstable')
ax.legend(handles=[stable_handle, unstable_handle], loc='upper left')
