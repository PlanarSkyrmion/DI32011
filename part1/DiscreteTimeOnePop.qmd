...
**Exercise:** Use python to simulate the solution of a general difference equation $N_{t+1} = H(N_t)$. This should be modular so you pass it different models in the form of different functions $H$. Test it with the Malthusian model and compare with @fig-plotmalthusian.
